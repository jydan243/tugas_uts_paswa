...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 style="color:orange">Data Panitia</h1>
    <p class="mb-4"> </p>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="panitia_add.php" class="btn btn-success">Tambah</a>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-danger" nim="dataTable" wnimth="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <td>No.</td>
                            <td>NIM</td>
