...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 style="color:orange">Perlengkapan</h1>
    <p class="mb-4"> </p>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row px-3 justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-success">Data Perlengkapan</h6>
                <a href="perlengkapan_add.php" class="btn btn-primary">Tambah</a>
            </div>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-danger" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <td>No.</td>
                            <td>Perlengkapan</td>
